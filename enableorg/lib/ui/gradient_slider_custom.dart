...
class GradientSliderCustom extends StatefulWidget {
  ...
  @override
  State<GradientSliderCustom> createState() => _GradientSliderState();
}

class _GradientSliderState extends State<GradientSliderCustom> {
